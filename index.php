    ...
    <div class="col-md-8" style="text-align:center; width:66.6%;float:left">
        <div id="pregled">
            <table id="tabela" class="table sortable table-bordered table-hover ">
                ...
                <tbody>
                <?php
                while ($ugovor = $ugovori->fetch_array()) {
                    ?>
                    <tr id="tr-<?php echo $ugovor["id"] ?>">
                        ...
                        <td><?php echo $ugovor["pas_id"] ?></td>
                        <td><?php echo $ugovor["udomitelj_id"] ?></td>
                        <td>
                        ...
                        <form action="#" method="post" id="dodaj-form-ugovor">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="number" style="border: 1px solid black" name="pas_id"
                                               class="form-control" placeholder="Pas *" value=""/>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" style="border: 1px solid black" name="udomitelj_id"
                                               class="form-control" placeholder="Udomitelj *" value=""/>
                                    </div>
                                    <div class="form-group">
                                        <button id="btnDodaj" type="submit" class="btn btn-success btn-block"
                                                style="background-color: orange; border: 1px solid black;"><i
                        ...
                        <form action="#" method="post" id="izmeni-form-ugovor">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input id="ugovor-pas-id" type="number" name="pas_id" class="form-control"
                                               placeholder="Pas *" value=""/>
                                    </div>
                                    <div class="form-group">
                                        <input id="ugovor-udomitelj-id" type="number" name="udomitelj_id"
                                               class="form-control" placeholder="Udomitelj *" value=""/>
                                    </div>
                                    <div class="form-group">
